...
#define VFWMACCBF16 (binstoi("00110001"))
#define VFF_ALL_OPTYPES {VFMUL,VFMACC,VFNMACC,VFMSAC,VFNMSAC,VFMADD,VFNMADD,VFMSUB,VFNMSUB,VFWMACCBF16}
#define VFF_NEED_FRS1_OPTYPES {VFMUL,VFMACC,VFNMACC,VFMSAC,VFNMSAC,VFMADD,VFNMADD,VFMSUB,VFNMSUB,VFWMACCBF16}
// vff funcop type
#define VFD_NUM 2
...
// vconvert type 
  ...
  #define VFWCVTBF16_FFV   (binstoi("11001101"))
  ...
  #define VFNCVTBF16_FFW   (binstoi("11011101"))
  ...
  VFWCVT_XUFV, VFWCVT_XFV, VFWCVT_FXUV, VFWCVT_FXV, VFWCVT_FFV, VFWCVTBF16_FFV, VFWCVT_RTZ_XUFV, VFWCVT_RTZ_XFV, \
  VFNCVT_XUFW, VFNCVT_XFW, VFNCVT_FXUW, VFNCVT_FXW, VFNCVT_FFW, VFNCVT_ROD_FFW, VFNCVT_RTZ_XUFW ,VFNCVT_RTZ_XFW, VFNCVTBF16_FFW, VFRSQRT7, VFREC7}
  ...
  #define VFCVT_16_OPTYPES {VFCVT_XUFV,VFCVT_XFV,VFCVT_FXUV,VFCVT_FXV,VFCVT_RTZ_XUFV,VFCVT_RTZ_XFV,VFWCVT_XUFV,VFWCVT_XFV,VFWCVT_FXUV,VFWCVT_FXV,VFWCVT_FFV,VFWCVTBF16_FFV,VFWCVT_RTZ_XUFV,VFWCVT_RTZ_XFV,VFNCVT_XUFW,VFNCVT_XFW,VFNCVT_RTZ_XUFW,VFNCVT_RTZ_XFW,VFNCVTBF16_FFW,VFRSQRT7,VFREC7}
